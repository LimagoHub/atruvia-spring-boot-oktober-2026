package de.atruvia.oniondemo.domain.schwein.aggregate;
...
import de.atruvia.oniondemo.domain.shared.AggregateRoot;
...
public class Schwein extends AggregateRoot {
    ...
    private void setName(final String name) {
        ...
        if(name.length() > MAX_NAME_LENGTH) throw new IllegalArgumentException("Name darf nicht länger als " + MAX_NAME_LENGTH + " Zeichen sein");
